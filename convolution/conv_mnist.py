...
h1_dropout = tf.nn.dropout(h1_fc, keep_prob)
output = tf.nn.softmax(tf.matmul(h1_dropout, w4) + b4)
...
print(sess.run(h1_fc, feed_dict={x:mnist.train.next_batch(50)[0]}))
# for i in range(20000):
#     batch = mnist.train.next_batch(50)
#     if i % 100 == 0:
#         a = sess.run(h2_pool, feed_dict={
