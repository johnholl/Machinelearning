...
weights = np.load("weights_72.npy", encoding="latin1")
print(weights[0])
...
fc2_weight = weight_variable(shape=[256, 3], name='fc2_weight', weight_value=weights[6])
fc2_bias = bias_variable(shape=[3], name='fc2_bias', bias_value=weights[7])
